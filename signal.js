// WebRTC signaling server for Render deployment
...
function joinRoom(roomId, clientId, ws) {
  ...
  console.log(`[${roomId}] ${clientId} joined (${members.size} total)`)
}
...
function leaveRoom(roomId, clientId) {
  ...
  console.log(`[${roomId}] ${clientId} left (${members.size} remaining)`)
